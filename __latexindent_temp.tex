...
\begin{itemize}
    ...
    \item Quantifiers are tied to variables within its scope. In $\exists x, Px \wedge (\forall y, \lnot Py \rightarrow Px)$, 
    $\exists x$ applies to the whole formula, but $\forall y$ only applies to the inner bracket.
